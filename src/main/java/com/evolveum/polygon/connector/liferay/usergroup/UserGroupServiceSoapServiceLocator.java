...
public class UserGroupServiceSoapServiceLocator extends org.apache.axis.client.Service implements com.evolveum.polygon.connector.liferay.usergroup.UserGroupServiceSoapService {
    ...
    private java.lang.String Portal_UserGroupService_address = "http://localhost:8080/api/axis/Portal_UserGroupService";
    ...
    public com.evolveum.polygon.connector.liferay.usergroup.UserGroupServiceSoap getPortal_UserGroupService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.evolveum.polygon.connector.liferay.usergroup.Portal_UserGroupServiceSoapBindingStub _stub = new com.evolveum.polygon.connector.liferay.usergroup.Portal_UserGroupServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.evolveum.polygon.connector.liferay.usergroup.UserGroupServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.evolveum.polygon.connector.liferay.usergroup.Portal_UserGroupServiceSoapBindingStub _stub = new com.evolveum.polygon.connector.liferay.usergroup.Portal_UserGroupServiceSoapBindingStub(new java.net.URL(Portal_UserGroupService_address), this);
                _stub.setPortName(getPortal_UserGroupServiceWSDDServiceName());
                return _stub;
            }
        }
