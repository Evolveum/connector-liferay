...
public class UserServiceSoapServiceLocator extends org.apache.axis.client.Service implements com.evolveum.polygon.connector.liferay.user.UserServiceSoapService {
    ...
    public com.evolveum.polygon.connector.liferay.user.UserServiceSoap getPortal_UserService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.evolveum.polygon.connector.liferay.user.Portal_UserServiceSoapBindingStub _stub = new com.evolveum.polygon.connector.liferay.user.Portal_UserServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.evolveum.polygon.connector.liferay.user.UserServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.evolveum.polygon.connector.liferay.user.Portal_UserServiceSoapBindingStub _stub = new com.evolveum.polygon.connector.liferay.user.Portal_UserServiceSoapBindingStub(new java.net.URL(Portal_UserService_address), this);
                _stub.setPortName(getPortal_UserServiceWSDDServiceName());
                return _stub;
            }
        }
