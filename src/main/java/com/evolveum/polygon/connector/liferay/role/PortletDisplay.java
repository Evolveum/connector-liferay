...
public class PortletDisplay  implements java.io.Serializable {
    ...
    private com.evolveum.polygon.connector.liferay.role.StringBundler content;
    ...
    public PortletDisplay(
           ...
           int columnPos,
           com.evolveum.polygon.connector.liferay.role.StringBundler content,
     ...
     * @return content
     */
    public com.evolveum.polygon.connector.liferay.role.StringBundler getContent() {
        return content;
    }
     ...
     * @param content
     */
    public void setContent(com.evolveum.polygon.connector.liferay.role.StringBundler content) {
        this.content = content;
    }
