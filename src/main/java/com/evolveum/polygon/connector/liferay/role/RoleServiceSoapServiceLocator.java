...
public class RoleServiceSoapServiceLocator extends org.apache.axis.client.Service implements com.evolveum.polygon.connector.liferay.role.RoleServiceSoapService {
    ...
    public com.evolveum.polygon.connector.liferay.role.RoleServiceSoap getPortal_RoleService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.evolveum.polygon.connector.liferay.role.Portal_RoleServiceSoapBindingStub _stub = new com.evolveum.polygon.connector.liferay.role.Portal_RoleServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.evolveum.polygon.connector.liferay.role.RoleServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.evolveum.polygon.connector.liferay.role.Portal_RoleServiceSoapBindingStub _stub = new com.evolveum.polygon.connector.liferay.role.Portal_RoleServiceSoapBindingStub(new java.net.URL(Portal_RoleService_address), this);
                _stub.setPortName(getPortal_RoleServiceWSDDServiceName());
                return _stub;
            }
        }
