...
public class UserGroupRoleSoap  implements java.io.Serializable {
    ...
    private com.evolveum.polygon.connector.liferay.user.UserGroupRolePK primaryKey;
    ...
    public UserGroupRoleSoap(
           long groupId,
           com.evolveum.polygon.connector.liferay.user.UserGroupRolePK primaryKey,
           long roleId,
           long userId) {
     ...
     * @return primaryKey
     */
    public com.evolveum.polygon.connector.liferay.user.UserGroupRolePK getPrimaryKey() {
        return primaryKey;
    }
     ...
     * @param primaryKey
     */
    public void setPrimaryKey(com.evolveum.polygon.connector.liferay.user.UserGroupRolePK primaryKey) {
        this.primaryKey = primaryKey;
    }
