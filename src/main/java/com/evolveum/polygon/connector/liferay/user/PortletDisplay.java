...
public class PortletDisplay  implements java.io.Serializable {
    ...
    private com.evolveum.polygon.connector.liferay.user.StringBundler content;
    ...
    public PortletDisplay(
           ...
           int columnPos,
           com.evolveum.polygon.connector.liferay.user.StringBundler content,
     ...
     * @return content
     */
    public com.evolveum.polygon.connector.liferay.user.StringBundler getContent() {
        return content;
    }
     ...
     * @param content
     */
    public void setContent(com.evolveum.polygon.connector.liferay.user.StringBundler content) {
        this.content = content;
    }
